...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $organise_address3 = trim($_POST['organise_addres3']);
    $organise_address4 = trim($_POST['organise_addres4']);
    ...
    $stmt = $conn->prepare("UPDATE partners_details SET partner_type=?, first_name=?, last_name=?, email=?, phone=?, office_phone=?, dob=?, gender=?, organise_name=?, organise_address=?, organise_address2=?, organise_address3=?, organise_address4=?, landmark=?, city=?, pincode=?, district=?, state=?, aadhar_number=?, pan_number=?, gst=? WHERE id=?");
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="dashboard_title_area" style="margin-bottom: 30px;">
                    <h2 class="color-white">Edit Distributer</h2>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="dashboard_setting_box" style="background: rgba(40, 43, 53, 1);">
                    <div class="buyer-dashboard-edit-addresses-section">
                        <div class="account_details_page form_grid">
                            ...
                            <form class="edit_distributer" name="edit_distributer" action="" method="post" novalidate>
                                <input type="hidden" name="product_id" value="<?php echo htmlspecialchars($product_id); ?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <label class="form-label color-white">Partner Type</label>
                                            <input class="form-control" type="text" name="partner_type" value="Distributer" readonly />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input class="form-control" type="date" name="dob" placeholder="Date of Birth" value="<?php echo htmlspecialchars($product['dob']); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <label class="form-label color-white">GST Number</label>
                                            <input class="form-control" type="text" name="gst" placeholder="GST Number" value="<?php echo htmlspecialchars($product['gst']); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group mb-4">
                                            <button class="btn-primary">Update Seller</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
